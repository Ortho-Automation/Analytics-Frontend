...
import { useFocusedVolumeStore } from '../../store/focusedVolumeStore'
...
export function usePolygonsLayer() {
  const { polygons, polygons3D, computeVolume, addVolumeResult, volumeResults } = useVolumeStore()
  const { setFocusedVolumeResult } = useFocusedVolumeStore()
